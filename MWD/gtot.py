    ...
    def forward(self, x, y, C=None, A=None, mask=None):
        ...
        for i in range(self.max_iter):
            ...
            if mask is None:
                ...
                # if i == 23:
                # total_memory = torch.cuda.get_device_properties(1).total_memory / (1024 ** 3)  # 转为 GB
                # allocated_memory = torch.cuda.memory_allocated(1) / (1024 ** 3)  # 转为 GB
                # reserved_memory = torch.cuda.memory_reserved(1) / (1024 ** 3)  # 转为 GB
